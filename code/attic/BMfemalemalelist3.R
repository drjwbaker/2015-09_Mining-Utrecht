...
ggplot(gender2, aes(x = (YEAR), y = (n_genderyear/TOTAL_PRINTS), group = GENDER, linetype = GENDER, shape = GENDER, colour = GENDER)) +
	geom_smooth() +
	geom_point() +
	xlim(1769, 1829) +
...
ggsave("BMfemalemalelist3.png", width = 12, height = 7)
